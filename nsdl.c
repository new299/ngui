...
void nsdl_rectangle_wire(SDL_Renderer *screen,int sx,int sy,int ex,int ey,uint8_t r,uint8_t g,uint8_t b,uint8_t a) {
...
void nsdl_lineS(SDL_Surface *screen,int start_x,int start_y,int end_x,int end_y,int color) {
